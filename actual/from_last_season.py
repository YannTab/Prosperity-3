...
class Trader:
            ...
            if not prevent_adverse or abs(best_ask_amount) <= adverse_volume:
                if best_ask <= fair_value - take_width:
                    ...
                    if quantity > 0:
                        ...
                        print(f"Arbitrage BUY {quantity} {product} @ {best_ask}")
            ...
            if not prevent_adverse or abs(best_bid_amount) <= adverse_volume:
                if best_bid >= fair_value + take_width:
                    ...
                    if quantity > 0:
                        ...
                        print(f"Arbitrage SELL {quantity} {product} @ {best_bid}")
    ...
    def market_make(
        ...
        if buy_quantity > 0:
            ...
            print(f"Marketmaked BUY {buy_quantity} {product} @ {round(bid)}")


        sell_quantity = self.LIMIT[product] + (position - sell_order_volume)
        if sell_quantity > 0:
            orders.append(Order(product, round(ask), -sell_quantity))  # Sell order
            print(f"Marketmaked SELL {sell_quantity} {product} @ {round(ask)}")
    ...
    def clear_position_order(
        ...
        if position_after_take > 0:
            ...
            if sent_quantity > 0:
                ...
                print(f"Closed {sent_quantity} {product} @ {fair_for_ask}")
